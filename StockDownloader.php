...
function createURL($ticker) {
	...
	$currentDay = date("j");
	$currentYear = date("Y");
	$preYear = $currentYear -3;
	
	
	
	return "https://ichart.finance.yahoo.com/table.csv?s=$ticker&a=$currentMonth&b=$currentDay&c=$preYear&d=$currentMonth&e=$currentDay&f=$currentYear&g=d&ignore=.csv";
}
...
//eventually change format to ----id | last  | open  | previous | high  | low   | volume | change | percent | date   
?>
